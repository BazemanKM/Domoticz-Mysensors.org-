...
-- Variable
local washer_status_uservar = 'wasdroger_status'
local energy_consumption = 'Wasdroger' --Name of Z-Wave plug that contains actual consumption of washingmachine (in Watts)
local washer_counter_uservar = 'wasdroger_counter' --Name of the uservariable that will contain the counter that is needed
...
sWatt, sTotalkWh = otherdevices_svalues['Wasdroger']:match("([^;]+);([^;]+)")
...
commandArray['SendNotification']='De wasdroger is klaar'
