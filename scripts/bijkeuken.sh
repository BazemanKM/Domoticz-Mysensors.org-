...
rtspUrl="rtsp://192.168.2.6:554/mpeg4?username=admin&password=XXXXXXXXX"   # Use https://sourceforge.net/projects/onvifdm/ to find your correct RTSP stream url
...
TelegramAPIToken=XXXXXXXX    # Telegram API token
